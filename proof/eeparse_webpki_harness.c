...
// server_name acknowledgement beside the other two extensions.
// -DCH_TRUST_WEBPKI comes from the launch line rather than a #define
// here, because handshake_parser.c is its own translation unit on that
// line and a define in this file would not reach it. A proof name is one

...
// every key field ch_quic holds (initial_rx, initial_tx, handshake_rx,
// handshake_tx, handshake_hp_rx, handshake_hp_tx, app_tx, all
// CH_QUIC_KEY_SETS slots of app_rx, app_hp_rx and app_hp_tx),

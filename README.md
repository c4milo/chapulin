...
caller: pins alone reach a server that has no public certificate, and pins
beside anchors make a chain pass both checks (docs/webpki.md, "Raw public
keys and SPKI pins"). The pins mean the same thing over QUIC as over TCP

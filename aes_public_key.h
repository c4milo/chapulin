// What an aes_public_key is made of. aes.h declares the type
...
// that only the two constructors in aes.c can fill is a key no
...
// on a fifth:
//
//   aes.c           writes the two constructors and the cipher
...
// body of the other.
#ifndef CH_AES_PUBLIC_KEY_H
#define CH_AES_PUBLIC_KEY_H
...
// AEAD_AES_128_GCM. aes.h states the three fields, what writes

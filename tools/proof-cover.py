...
def shipped_sources():
    ...
    # drbg.c and the ML-KEM, SHA-3, SHA-512, P-384, PKCS#1 v1.5 and webpki
    # signature-dispatch sources join through build variables.
    out |= {"drbg.c", "sha3.c", "sha512.c", "sha512_compress.c", "p384.c", "p384_field.c",
            "rsa_pkcs1.c", "webpki_sigalg.c", "mlkem.c", "mlkem_poly.c"}

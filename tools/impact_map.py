...
# only an ecdsa mode and KEX=pq package, so the five together are every
# source some object carries.
LIB_AXES = ["", "TRUST=ca-rsa", "TRUST=webpki", "TRANSPORT=quic",
...
class Mapping:
    ...
    def lib_legs(self):
        ...
        check` builds. The fifth adds the sources only an ecdsa mode and

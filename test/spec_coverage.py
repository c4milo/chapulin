...
p384.c p384_field.c rsa.c rsa_mont.c rsa_pkcs1.c pem.c x509.c x509_der.c x509_ca.c webpki_time.c webpki_name.c webpki_spki.c webpki_sigalg.c webpki_ext.c webpki_cert.c buf.c record.c keysched.c io.c handshake_message.c
...
DRIVERS = ["diff_test.c", "diff_driver.h", "diff_handshake_parser.h", "diff_handshake_certificate.h",
           ...
           "diff_sha512.h", "diff_p384.h", "diff_rsa_pkcs1.h", "diff_webpki.h", "diff_webpki_sigalg.h", "diff_webpki_cert.h", "diff_x509.h",
           "diff_x509_bounds.h",

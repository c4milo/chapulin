...
| New crypto primitive | Lean spec module (styleguide: [spec/lean/CONTRACT.md](spec/lean/CONTRACT.md)), RFC/selftest vectors in `test/unit_test.c`, differential entries in `test/diff_test.c`, CBMC harness |

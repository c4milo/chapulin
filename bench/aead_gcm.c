// gcm.c compiled with one more entry, for bench/aead.c only.
// counter_mode and first_counter_block are static in gcm.c, so this
// file includes the source rather than linking its object, the way
// test/aes_equiv_hw.c includes aes_hw.c. The bench links this object
// in place of gcm.o, and gcm.c itself is unchanged: gcm_seal,
